...
2. Run ```npm i```
3. If desired, adjust the input in the input.js file
...
2. Then run the following command: ```docker run romancc/martian-robots```
3. Do the same for the testing image
